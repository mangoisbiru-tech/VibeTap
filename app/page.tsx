...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF] text-slate-900 font-sans overflow-x-hidden selection:bg-blue-200 relative">
      ...
      {/* Nav */}
      <nav className="sticky top-0 z-50 bg-[#F8FAFF] border-b border-slate-200/50 relative">
      ...
      <footer className="bg-transparent py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-6 text-slate-500 font-medium text-center">
          ...
          <div className="flex gap-6">
            <Link href="/legal" className="text-sm font-bold text-black hover:text-blue-600 transition-colors">
              Terms & Privacy
            </Link>
          </div>
        </div>
