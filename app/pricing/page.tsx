    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans overflow-x-hidden relative">
      ...
      <section className="py-12 px-6 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#0B1120] rounded-[2rem] p-6 md:p-10 text-white shadow-2xl relative overflow-hidden border border-slate-800">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-8 justify-between">
              <div className="flex-1 max-w-3xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-slate-300 text-[10px] font-bold uppercase tracking-widest mb-4 border border-white/5">
                  <Sparkles size={12} className="text-yellow-100" /> Custom Service
                </div>
                <h2 className="text-3xl md:text-4xl font-serif italic font-black mb-3 tracking-tight text-white">Alternative NFC<br />Extra Services</h2>
                <p className="text-slate-300 mb-6 leading-relaxed text-base font-medium">Want something more? We can set up your NFC stickers for a whole lot more than just payments.</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-3 gap-x-6 mb-6">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-2.5 text-slate-200 text-sm font-bold font-serif">
                ...
                <p className="text-slate-400 text-xs font-medium">Pricing depends on what you need. Drop us an email and we'll figure it out together.</p>
              </div>
              <div className="shrink-0 w-full lg:w-auto">
                <a href="mailto:tappaymy@outlook.com" className="flex items-center justify-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-2xl font-black transition-all hover:-translate-y-1 duration-300 text-lg w-full lg:w-auto">
