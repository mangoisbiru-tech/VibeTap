                  ...
                  <td className="px-6 py-4">
                    <div className="relative inline-block">
                      <select
                        ...
                        className="appearance-none bg-slate-50 border border-slate-200 text-slate-900 font-bold rounded-xl pl-4 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500/20 disabled:opacity-50 cursor-pointer"
                      >
